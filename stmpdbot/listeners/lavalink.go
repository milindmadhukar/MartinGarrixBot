...
func LavalinkTrackStartListener(b *stmpdbot.STMPDBot) disgolink.EventListener {
...
func LavalinkTrackEndListener(b *stmpdbot.STMPDBot) disgolink.EventListener {
...
func LavalinkTrackExceptionListener(b *stmpdbot.STMPDBot) disgolink.EventListener {
...
func LavalinkTrackStuckListener(b *stmpdbot.STMPDBot) disgolink.EventListener {
...
func LavalinkWebSocketClosedListener(b *stmpdbot.STMPDBot) disgolink.EventListener {
...
func playNextRadioSong(b *stmpdbot.STMPDBot, guildID snowflake.ID) {
	b.PlayNextRadioSong(guildID)
}

// reconnectRadio delegates to the bot's ReconnectRadio method
func reconnectRadio(b *stmpdbot.STMPDBot, guildID snowflake.ID) {
