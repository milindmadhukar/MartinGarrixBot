...
func GetSongEnrichment(b *stmpdbot.STMPDBot, ticker *time.Ticker) {
...
func enrichArtwork(ctx context.Context, b *stmpdbot.STMPDBot, client *utils.ItunesClient) int {
...
func enrichDates(ctx context.Context, b *stmpdbot.STMPDBot, client *utils.ItunesClient) int {
