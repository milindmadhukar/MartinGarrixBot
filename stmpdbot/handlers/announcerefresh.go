...
func RefreshAnnouncements(b *stmpdbot.STMPDBot, ticker *time.Ticker) {
	for ; ; <-ticker.C {
...
func refreshAnnouncementsOnce(ctx context.Context, b *stmpdbot.STMPDBot) (int, error) {
...
// for the row.
func editAnnouncement(ctx context.Context, b *stmpdbot.STMPDBot, row db.GetAnnouncementsToRefreshRow, components []discord.LayoutComponent) error {
