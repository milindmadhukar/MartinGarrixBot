...
// would ever notice.
func GetSongLyrics(b *mgbot.MartinGarrixBot, ticker *time.Ticker) {
...
func runLyricsCycle(ctx context.Context, b *mgbot.MartinGarrixBot, client *utils.LrclibClient) (utils.LyricsTally, error) {
