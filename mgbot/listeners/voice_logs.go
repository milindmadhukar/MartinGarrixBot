...
func VoiceLogJoinListener(b *mgbot.MartinGarrixBot) bot.EventListener {
...
func VoiceLogLeaveListener(b *mgbot.MartinGarrixBot) bot.EventListener {
...
func VoiceLogMoveListener(b *mgbot.MartinGarrixBot) bot.EventListener {
...
func postVoiceLog(b *mgbot.MartinGarrixBot, guildID snowflake.ID, member discord.Member, title, detail string, color int) {
